...
import fanAdminRoutes from './fanAdmin.routes';
import aboutRoutes from './about.routes';
import aboutAdminRoutes from './aboutAdmin.routes';
import offerRoutes, { cartRouter } from './offer.routes';
import offerAdminRoutes from './offerAdmin.routes';
...
router.use('/recommend-pick', recommendPickRoutes);
...
router.use('/admin/about', aboutAdminRoutes);
router.use('/available-offers', offerRoutes);
router.use('/offer-cart', cartRouter);
...
router.use('/admin/offers', offerAdminRoutes);
